...
/// <summary>
/// 技能格加2，满了就直接释放技能，技能距离加1
/// </summary>
public class Point_44 : MonoBehaviour
{
    private const int abilityEnergy = 2;
    ...
    void Update()
    {
        if (transform.position.y <= -ConstantParameter.diceHeight / 2f && !flag_Attackable)
        {
            ...
            attackable = pathFunction.FloodPath(originCell, CellParameter.CellInformation[originCell.X, originCell.Z].ObjectProperty.AbilityAttackDistance + 1, true, true);
